...
################################################################
# This is the functions script for the Race Code script to use #
#                                                              #
...
def WaitForGo():
	...
	if Globals.running:
		if Globals.skipLights:
			print 'Skipping lights...'
			Globals.startLights = ImageProcessor.THIRD_GREEN_GO
