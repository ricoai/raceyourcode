...
simulationLagFrames = 2				# Number of frames to delay the processing by to simulate camera lag
...
#maxPower = 0.75					# Maximum of allowed drive output - Approximate reverse calibration level
